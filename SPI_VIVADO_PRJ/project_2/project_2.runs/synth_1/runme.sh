...
HD_PWD='/home/ace96/University/TESTCHIP_2024/SPI_VIVADO_PRJ/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_digital_part.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_digital_part.tcl
