...
HD_PWD='/home/ace96/University/TESTCHIP_2024/SPI_VIVADO_PRJ/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_digital_part.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_digital_part.tcl -notrace
